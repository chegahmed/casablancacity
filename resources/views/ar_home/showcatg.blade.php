...
<section id="contentSection" >
        ...
        <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="left_content">
                <div class="single_page">
                    <ol class="breadcrumb">
                        <li><a href="#">{{str_replace('_',' ',$catg) }} /</a></li>
 ...
 <aside class="right_content">
                                    ...
                                    <li>
                                        <div class="media wow fadeInDown">
                                            <a href="single_page.html" class="media-left">
                                                <img alt="img" src="{{'../'.$nosactualite->image}}">
                                            </a>
                    ...
                    <div class="col-lg-6">
                        ...
                        @if(strcasecmp( $actualite->stug,$catg)==0)
                        ...
                        @endforeach
                         ...
                         @foreach($categories as $cat)
                                                ...
                                                @if( $scat->idcatg == $cat->id)
                                                  ...
                                                  <div class="col-xs-12">
                                                      <a  href="{{$cat->name}}/{{str_replace(' ','_',$scat->name)}}"  style="text-align:left; padding-left:6px" class="btn btn-default btn-lg btn-block">{{$scat->name}}
                                    ...
                                    <section class="sidebar ">
                                        <div class="page-sidebar  sidebar-nav">
                                            ...
                                            <ul id="menu" class="page-sidebar-menu">
                                                @foreach($categories as $cat)
                                                <li>
                                                    <a href="{{$cat->stug}}" style="background-color:  #ce1f30">
                                                ...
                                                @foreach($souscategories as $scat)
                                                @if( $scat->idcatg == $cat->id)
                                                <li style="background-color: #df4252 ">
                                                    <a href="{{$cat->stug}}/{{$scat->stug}}">
                                                        <i class="livicon" data-name="doc-portrait" data-c="#5bc0de" data-hc="#5bc0de" data-size="18" data-loop="true"></i>
