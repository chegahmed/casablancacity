        ...
        <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="left_content">
                <div class="single_page">
                    <ol class="breadcrumb">
                        <li><a href="index.html">{{str_replace('_',' ',$catg.'/'.$scatg.'/'.$sscatg) }} /</a></li>
                    ...
                    <div class="col-lg-6">
                        ...
                        @if(strcasecmp( $actualite->stug,$catg.'/'.$scatg.'/'.$sscatg)==0)
                                        ...
                                        <div class="page-sidebar  sidebar-nav">
                                            ...
                                            <ul id="menu" class="page-sidebar-menu">
                                               @foreach($souscategories as $scat)
                                                <li>
                                                    <a href="{{asset($catg.'/'.$scat->stug) }}" style="background-color:  #3573b7">
                                                ...
                                                <li style="background-color: #4597c4 ">
                                                    <a href="{{$s_scat->stug}}">
                                                        <i class="livicon" data-name="doc-portrait" data-c="#5bc0de" data-hc="#5bc0de" data-size="18" data-loop="true"></i>
                                                        <span class="title">{{$s_scat->name}} </span>
                                                        <span class="fa arrow"></span>
                                                    </a>
