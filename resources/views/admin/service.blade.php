            ...
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <h3 class="panel-title">
                        ...
                        Ajouter  les informations des services
                    </h3>
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        <label for="single-prepend-text" class="control-label">
                            Sélectionné Le Titre de Service :
                        </label>
                        <div class="input-group select2-bootstrap-prepend">
                            ...
                            <select name="titreservice" id="single-prepend-text" class="form-control select2">
                                ...
                                <option value="e_services">E-services</option>
                                <option value="Les_evenements_de_la_ville">Les evenements de la ville</option>
                                <option value="vous_demarches">vous démarches</option>
                                <option value="Communiques_de_presse">Communiqués de presse</option>
                                <option value="Actualites_des_Arrondissements">Actualités des Arrondissements</option>
                                <option value="Les_indisponsables">Les indisponsables</option>
                                <option value="Votres_Arrondissemen">Votres Arrondissement</option>
                                <option value="Actualites">Actualités</option>
                                <option value="Le_Kiosque">Le Kiosque</option>
                                <option value="Les_site_de_la_ville_casablanca">Les site de la ville casablanca</option>
                                <option value="Le_mot_du_president">Le mot du président</option>
                                <option value="rehabilitation_de_la_coupe">réhabilitation de la coupe</option>
                                <option value="slide_Accueil">slide Accueil</option>
