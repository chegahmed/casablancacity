...
<div class="row">
    ...
    <form action="ar_souscategorie" method="post" enctype="multipart/form-data">
        {!! csrf_field() !!}
        <div class="col-md-6">
                    ...
                    <table id="datatable" class="table table-striped table-bordered">
                      ...
                      <tbody>
                            @foreach($souscategories as $key=>$souscategorie)
                                ...
                                <form action="ar_souscategorie/{{$souscategorie ->id}}" method="POST" >
                                    {!! csrf_field() !!}
