...
<div class="row">
    ...
    <form action="s_scategorie" method="post" enctype="multipart/form-data">
        {!! csrf_field() !!}
        <div class="col-md-6">
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    <div class="form-group">
                        <label>
                           Entré Nom de Sous sous Catégorie :
                        </label>
                     ...
                     <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="e1" class="control-label">Sélectionné sous Catégorie</label>
                    ...
                    <table id="datatable" class="table table-striped table-bordered">
                      ...
                      <tbody>
                            @foreach($s_scategories as $key=>$s_scategorie)
                                ...
                                <form action="s_scategorie/{{$s_scategorie ->id}}" method="POST" >
                                    {!! csrf_field() !!}
