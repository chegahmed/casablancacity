...
<link href="designeAdmin/vendors/bootstrap-wysihtml5-rails-b3/vendor/assets/stylesheets/bootstrap-wysihtml5/core-b3.css"  rel="stylesheet" media="screen"/>
<link href="designeAdmin/css/pages/editor.css" rel="stylesheet" type="text/css"/>
...
<div class="row">
    ...
    <form action="ar_actualite" method="post" enctype="multipart/form-data">
        {!! csrf_field() !!}
        <div class="col-md-10">
                ...
                <div class="panel-body">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="titreactualite" class="form-control"  data-mask/>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="input-group select2-bootstrap-append">
                            <select name="url" id="single-append-text" class="form-control select2-allow-clear">


                                @foreach($categories as $key=>$cat)
                                <option value="{{$cat->name}}" style="color: red"><h4>{{ $cat ->name }}</h4></option>

                                @foreach($souscategories as $s_catg)
                                @if( $s_catg->idcatg ==$cat ->id)
                                <option value="{{$cat->name}}/{{$s_catg->name}}" style="color: blue"><h5>{{$s_catg->name}}</h5></option>

                                @foreach($s_scategories as $s_scat)
                                @if( $s_scat->id_souscatg == $s_catg->id)
                                <option value="{{$cat->name}}/{{$s_catg->name}}/{{$s_scat->name}}" ><h6>{{$s_scat->name}}</h6></option>
                    ...
                    <div class="row">
                        <div class="panel panel-success">
                            ...
                            <div class="bootstrap-admin-panel-content">
                                <textarea name="contenu"  id="ckeditor_full"></textarea>
                            </div>
                        </div>
                    </div>
        ...
        <div class="x_panel">
            ...
            <div class="x_content">
                ...
                <table id="datatable" class="table table-striped table-bordered">
                    ...
                    <form action="ar_actualite/{{$actualite ->id}}" method="POST" >
                        {!! csrf_field() !!}
                        <input type="hidden" name="_method" value="PATCH"/>
                        
                        <td >{{ $actualite ->url }}</td>
                        <td >
                            <input type="text" name="titre" class="form-control input-small" value="{{ $actualite ->titre }}">
                        </td>
                        <td >
                            <textarea class="col-md-11" name="content" class="form-control input-small" >{{ $actualite ->content }}</textarea>
                        </td>
                        <td>
...
<script  src="designeAdmin/vendors/ckeditor/ckeditor.js" type="text/javascript"></script>
<script  src="designeAdmin/vendors/ckeditor/adapters/jquery.js" type="text/javascript" ></script>
<script  src="designeAdmin/vendors/tinymce/js/tinymce/tinymce.min.js" type="text/javascript" ></script>
<script  src="designeAdmin/vendors/bootstrap-wysihtml5-rails-b3/vendor/assets/javascripts/bootstrap-wysihtml5/wysihtml5.js" type="text/javascript"></script>
<script  src="designeAdmin/vendors/bootstrap-wysihtml5-rails-b3/vendor/assets/javascripts/bootstrap-wysihtml5/core-b3.js" type="text/javascript"></script>
<script  src="designeAdmin/js/pages/editor.js" type="text/javascript">< /scrip
