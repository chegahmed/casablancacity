                    ...
                    <div class="col-lg-8 col-md-8 col-sm-8">
                        <div class="left_content">
                            <div class="single_post_content">
                                <h2><span>LES ÉVÉNEMENTS DE LA VILLE</span></h2>
                            ...
                            <div class="fashion_technology_area">
                                <div class="fashion">
                                    <div class="single_post_content">
                                        <h2><span>ACTUALITÉS DES ARRONDISSEMENTS</span></h2>              
                                        <ul class="business_catgnav wow fadeInDown">
                                        ...
                                        <ul class="business_catgnav">
                                            <li>
                                                <figure class="bsbig_fig wow fadeInDown">
                                                    ...
                                                    <figcaption>
                                                        <a href="single_page.html">BIENVENUE SUR LA PLATE-FORME DE RÉCLAMATION E-Service</a>
                                                    </figcaption>
                                                    <p>Pour une ville propre 
                                                        Participer à l'amélioration de votre cadre de vie
                                                        Signaler les anomalies constatées dans votre ville 
                                                        Collaborer avec vos élus communaux</p>
                                                </figure>
                                            </li>
                                        </ul>
                                        <ul class="spost_nav">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4">
                        <aside class="right_content">
                            ...
                            <div class="single_sidebar wow fadeInDown">
                                <h2><span>Le mot du Président :</span></h2>
                            ...
                            <h5>{{$service->url}} Le mot du Président :Le mot du Président :Le mot du Président :Le mot du Président :</h5>
