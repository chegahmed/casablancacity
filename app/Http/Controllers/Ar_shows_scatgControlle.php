...
class Ar_shows_scatgControlle extends Controller
{
    /**
    ...
    public function index()
    {
     ...
     public function Show_s_scatg($catg,$scatg,$sscatg)
    {
        ...
        return view('ar_home.shows_scatg')->withCategories($categorie)
